<template>
  <div class="rbt-overlay-page-wrapper pt--200">
    <div class="breadcrumb-image-container breadcrumb-style-max-width">
      <div class="breadcrumb-image-wrapper">
        <v-img src="bg/bg-image-10.jpg" alt="Education Images" />
      </div>
    ...
    <div
      class="rbt-putchase-guide-area breadcrumb-style-max-width rbt-section-gapBottom"
    >
      <div class="rbt-article-content-wrapper">
        <div
          class="post-thumbnail mb--30 position-relative wp-block-image alignwide"
        >
          <v-img class="w-100" src="blog/blog-card-01.jpg" alt="Blog Images" />
        </div>
        <div class="content">
